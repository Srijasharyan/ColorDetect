...
Original file is located at
    https://colab.research.google.com/drive/1h4NA0DNfhggKoKlrOaGSJpH2TbXqfgz3
"""
...
mydict={'air_force_blue_raf': ['Air Force Blue (Raf)', '#5d8aa8', '93', '138', '168'],
 'air_force_blue_usaf': ['Air Force Blue (Usaf)', '#00308f', '0', '48', '143'],
 'air_superiority_blue': ['Air Superiority Blue',
  '#72a0c1',
  '114',
  '160',
  '193'],
 ...
 'chartreuse_traditional': ['Chartreuse (Traditional)',
  '#dfff00',
  '223',
  '255',
  '0'],
 ...
 'cherry_blossom_pink': ['Cherry Blossom Pink',
  '#ffb7c5',
  '255',
  '183',
  '197'],
 ...
 'chocolate_traditional': ['Chocolate (Traditional)',
  '#7b3f00',
  '123',
  '63',
  '0'],
 ...
 'forest_green_traditional': ['Forest Green (Traditional)',
  '#014421',
  '1',
  '68',
  '33'],
 ...
 'gray_html_css_gray': ['Gray (Html/Css Gray)',
  '#808080',
  '128',
  '128',
  '128'],
 'gray_x11_gray': ['Gray (X11 Gray)', '#bebebe', '190', '190', '190'],
 'green_color_wheel_x11_green': ['Green (Color Wheel) (X11 Green)',
  '#0f0',
  '0',
  '255',
  '0'],
 'green_crayola': ['Green (Crayola)', '#1cac78', '28', '172', '120'],
 'green_html_css_green': ['Green (Html/Css Green)',
  '#008000',
  '0',
  '128',
  '0'],
 ...
 'international_klein_blue': ['International Klein Blue',
  '#002fa7',
  '0',
  '47',
  '167'],
 'international_orange_aerospace': ['International Orange (Aerospace)',
  '#ff4f00',
  '255',
  '79',
  '0'],
 'international_orange_engineering': ['International Orange (Engineering)',
  '#ba160c',
  '186',
  '22',
  '12'],
 'international_orange_golden_gate_bridge': ['International Orange (Golden Gate Bridge)',
  '#c0362c',
  '192',
  '54',
  '44'],
 ...
 'khaki_html_css_khaki': ['Khaki (Html/Css) (Khaki)',
  '#c3b091',
  '195',
  '176',
  '145'],
 'khaki_x11_light_khaki': ['Khaki (X11) (Light Khaki)',
  '#f0e68c',
  '240',
  '230',
  '140'],
 ...
 'light_cornflower_blue': ['Light Cornflower Blue',
  '#93ccea',
  '147',
  '204',
  '234'],
 ...
 'light_pastel_purple': ['Light Pastel Purple',
  '#b19cd9',
  '177',
  '156',
  '217'],
 ...
 'medium_candy_apple_red': ['Medium Candy Apple Red',
  '#e2062c',
  '226',
  '6',
  '44'],
 ...
 'medium_lavender_magenta': ['Medium Lavender Magenta',
  '#dda0dd',
  '221',
  '160',
  '221'],
 ...
 'midnight_green_eagle_green': ['Midnight Green (Eagle Green)',
  '#004953',
  '0',
  '73',
  '83'],
 ...
 'olive_drab_web_olive_drab_3': ['Olive Drab (Web) (Olive Drab #3)',
  '#6b8e23',
  '107',
  '142',
  '35'],
 ...
 'pale_cornflower_blue': ['Pale Cornflower Blue',
  '#abcdef',
  '171',
  '205',
  '239'],
 ...
 'pale_robin_egg_blue': ['Pale Robin Egg Blue',
  '#96ded1',
  '150',
  '222',
  '209'],
 ...
 'royal_blue_traditional': ['Royal Blue (Traditional)',
  '#002366',
  '0',
  '35',
  '102'],
 ...
 'sacramento_state_green': ['Sacramento State Green',
  '#00563f',
  '0',
  '86',
  '63'],
 'saddle_brown': ['Saddle Brown', '#8b4513', '139', '69', '19'],
 'safety_orange_blaze_orange': ['Safety Orange (Blaze Orange)',
  '#ff6700',
  '255',
  '103',
  '0'],
 ...
 'shocking_pink_crayola': ['Shocking Pink (Crayola)',
  '#ff6fff',
  '255',
  '111',
  '255'],
 ...
 'smalt_dark_powder_blue': ['Smalt (Dark Powder Blue)',
  '#039',
  '0',
  '51',
  '153'],
 ...
 'stil_de_grain_yellow': ['Stil De Grain Yellow',
  '#fada5e',
  '250',
  '218',
  '94'],
 ...
 'university_of_california_gold': ['University Of California Gold',
  '#b78727',
  '183',
  '135',
  '39'],
...
column=["color_name","hex","R","G","B"]
csv = pd.DataFrame.from_dict(mydict, orient='index',columns=column)

# def colorData(COLORS):
#   index=["color","color_name","hex","R","G","B"]
#   csv = pd.read_csv(COLORS, names=index, header=None)
#   return csv

# COLORS='colors.csv'
# csv=colorData(COLORS)

def Dist(col1,col2):
  (R,G,B)=col1
  (r,g,b)=col2
  d=math.sqrt((R - r)**2 + (G - g)**2 + (B-b)**2)
  return d
...
def getColorName(R,G,B):
    ...
    for i in range(len(csv)):
        col2=(int(csv.iloc[i, 2]),int(csv.iloc[i,3]),int(csv.iloc[i,4]))
        d= Dist(col,col2)
...
def getMatchedColorPixelR(R,G,B):
    col=(R,G,B)
    minimum = 10000
    for i in range(len(csv)):
        # col2=(int(csv.loc[i,"R"]),int(csv.loc[i,"G"]),int(csv.loc[i,"B"]))
        col2=(int(csv.iloc[i, 2]),int(csv.iloc[i,3]),int(csv.iloc[i,4]))
        d= Dist(col,col2)
        if(d<=minimum):
            minimum = d
            red=int(csv.iloc[i,2])


    return red
def getMatchedColorPixelG(R,G,B):
        col=(R,G,B)
        minimum = 10000
        for i in range(len(csv)):
            # col2=(int(csv.loc[i,"R"]),int(csv.loc[i,"G"]),int(csv.loc[i,"B"]))
            ...
            if(d<=minimum):
                ...
                green=int(csv.iloc[i,3])


        return green
def getMatchedColorPixelB(R,G,B):
            col=(R,G,B)
            minimum = 10000
            for i in range(len(csv)):
                # col2=(int(csv.loc[i,"R"]),int(csv.loc[i,"G"]),int(csv.loc[i,"B"]))
                ...
                if(d<=minimum):
                    ...
                    blue=int(csv.iloc[i,4])

            return blue

def precentMatch(R,G,B):
    col=(R,G,B)
    minimum = 10000
    for i in range(len(csv)):
        col2=(int(csv.iloc[i, 2]),int(csv.iloc[i,3]),int(csv.iloc[i,4]))
        ...
        if(d<=minimum):
            minimum = d
            red = abs(R- int(csv.iloc[i, 2]))/(float(csv.iloc[i,2])+0.1)
            blue = abs(B- int(csv.iloc[i,4]))/(float(csv.iloc[i,4])+0.1)
            green = abs(G- int(csv.iloc[i,3]))/(float(csv.iloc[i,3])+0.1)


    return 100-((red+blue+green)/3*100)
...
# inputCordinate(x,y) (67, 75, 38)

# getColorName(inputCordinate(x,y)) Army Green

# precentMatch(inputCordinate(x,y)) 86.98159303882196

# getColorCode(inputCordinate(x,y)) #4b5320

# getMatchedColorPixel(inputCordinate(x,y)) (75, 83, 32)

def returnOriginalimage(color):
  image = np.full((20, 20, 3), color, np.uint8)
  plt.title('Original color')
  return plt.imshow(image)

def returnDetectedimage(color):
  detimage= np.full((20, 20, 3), getMatchedColorPixel(color), np.uint8)
  plt.title('Detected color')
  return plt.imshow(detimage)

# returnDetectedimage(inputCordinate(x,y))

# returnOriginalimage(inputCordinate(x,y))